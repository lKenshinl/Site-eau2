	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-sm-9 maincontent">
				...
				<p>
					Nous aimerions recevoir vos retours. Remplissez le formulaire ci-dessous avec quelques informations sur votre deùande et l'equipe de l'O vous répondra dans les plus brefs délais. Veuillez prévoir quelques jours pour avant la réponse.
				</p>
				<br>
					<form>
						<div class="row">
							...
							<div class="col-sm-4">
								<input class="form-control" type="text" placeholder="Numero de téléphone">
							</div>
						</div>
						<br>
						<div class="row">
