	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img class="logo" src="assets/images/logo.png" alt="Progressus HTML5 template"></a>
			</div>
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="sidebar-left.html">Best seller </a></li>
							<li class="active"><a href="sidebar-right.html">Nos packs</a></li>
						</ul>
					</li>
